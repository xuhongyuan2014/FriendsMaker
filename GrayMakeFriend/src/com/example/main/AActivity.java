...
/*	private Handler mhandler=new Handler(){//未使用
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        //接收name值
        if(bundle!=null&&bundle.getString("username")!=null)searchname = bundle.getString("username");
		...
		listview1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				UsersHuiHua uhh=(UsersHuiHua) listview1.getItemAtPosition(position);
				
				Intent intent = new Intent(AActivity.this, ListUserDetailsActivity.class);
	...
	public void searchUserList(){		
		...
		HttpEngine.getHttpEngine().post(Constant.selectUsersList, para, new AsyncHttpResponseHandler(){
...
/*						Message msg = handler.obtainMessage(HandlerConstants.GET_USER_LIST_ERROR,"加载数据失败");//两个参数，what and obj
	...
	public boolean isSearch(){
		if(searchname.equals(""))return false;
		else return true;
