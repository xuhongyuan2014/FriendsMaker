...
public class SelectNumText extends PopupWindow implements OnClickListener {
	...
	public SelectNumText(Activity context,final View Fieldview,String title) {
		super(context);
		mContext = context;
		//this.textValue = ((TextView)Fieldview).getText().toString();
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.numtext_dialog, null);
